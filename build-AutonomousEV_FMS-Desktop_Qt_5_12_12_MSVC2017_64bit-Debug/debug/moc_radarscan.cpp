...
#include "../../AutonomousEV_FMS/radarscan.h"
...
void radarScan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<radarScan *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject radarScan::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_radarScan.data,
    qt_meta_data_radarScan,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *radarScan::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "MainWindow"))
        return static_cast< MainWindow*>(this);
